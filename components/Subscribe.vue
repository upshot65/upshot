<template>
  <div class="flex justify-center items-center py-10 px-2 md:px-4 lg:px-8">
    ...
    >
      ...
      <img class="absolute top-0 left-0 h-auto w-full max-w-[100px]" src="/images/form-shape-1.png" alt=""/>
      <img class="absolute bottom-0 right-0 h-auto w-full max-w-[100px]" src="/images/form-shape-2.png" alt=""/>
