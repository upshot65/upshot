<template>
    <section>
      <div class="relative overflow-hidden flex justify-center mx-auto cursor-pointer group w-full">
        <img src="/images/popular-main.png" alt="" class="transform w-full transition duration-300 group-hover:scale-105" />
          ...
          >
            ...
            >
              <div class="bg-white rounded-lg overflow-hidden h-full">
                <img src="/public/images/event-img.png" :alt="event.title" class="w-full h-48 object-cover rounded-xl" />
                <div class="p-4">
    ...
    <section class="photo-gallery-section">
        <div class="p-6">
            ...
            <div class="col-span-1 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/200x150?text=Image+1" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            <div class="col-span-2 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/400x150?text=Image+2" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            <div class="col-span-1 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/200x150?text=Image+3" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            </div>
            <div class="grid grid-cols-5 gap-5">
            <!-- Second Row -->
            <div class="col-span-2 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/300x150?text=Image+4" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            <div class="col-span-1 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/150x150?text=Image+5" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            <div class="col-span-2 rounded-lg overflow-hidden bg-gray-300">
                <img src="https://via.placeholder.com/300x150?text=Image+6" alt="Dummy Image" class="w-full h-full min-h-[290px] object-cover" />
            </div>
            </div>
        </div>
    </section>
...
const updateCurrentDot = (position) => {
  ...
  .prebook-button, .highlight-button {
    margin-top: 12px;
    padding: 8px 12px;
    border-radius: 60px;
    font-size: 14px;
